...
func Set(key string, val interface{}, expired time.Duration) error {
    ...
    if err := enc.Encode(val); err != nil {
        return errors.New("encode:" + err.Error())
    }
...
func ZRangeByScore(key string, min int64, max int64) ([]string, error) {
    ...
    if err != nil {
        return nil, errors.New("ZRangeByScoreErr:" + err.Error())
    }
    return reply, nil
}
...
func ZAddBatch(key string, members interface{}) (err error) {
    ...
    if err != nil {
        err = errors.New("ZAddBatch err:" + err.Error())
    }
    return
}
...
func Hincrby(key, field string, num interface{}) (interface{}, error) {
    ...
    if err != nil {
        return nil, errors.New("Hincrby err:" + err.Error())
    }
...
func Hmget(key string, fields ...interface{}) ([]interface{}, error) {
    ...
    if err != nil {
        return nil, errors.New("Hmget err:" + err.Error())
    }
...
func Hgetall(key string, objPtr interface{}) error {
    ...
    if err != nil {
        return errors.New("Hgetall err:" + err.Error())
    }
...
func PexpireSecond(key string, seconds int64) error {
    ...
    if key == "" {
        ...
        return errors.New("PexpireSecond:" + errMsg)
    }
...
func LPush(key string, value interface{}) (data int, err error) {
    ...
    if err != nil {
        return ret, errors.New("LPush err:" + err.Error())
    }
    return ret, nil
}
...
func LPushBatch(key string, values interface{}) (data int, err error) {
    ...
    if err != nil {
        err = errors.New("LPushBatch err:" + err.Error())
        return
    }
    data = reply
    return
...
func LTrim(key string, start, end int64) (err error) {
    ...
    if err != nil {
        err = errors.New("LTrim err:" + err.Error())
        return
    }
    return
}
...
func BRPop(key string, timeout int) ([]interface{}, error) {
    ...
    if err != nil {
        return ret, errors.New("BRPOP err:" + err.Error())
    }
...
func LREM(key string, count int, value interface{}) (data int, err error) {
    ...
    if err != nil {
        err = errors.New("LREM err:" + err.Error())
        return
    }
    data = reply
    return
...
func INCR(key string) (data int, err error) {
    ...
    if err != nil {
        err = errors.New("INCR err:" + err.Error())
        return
    }
    data = reply
    return
...
func DECR(key string) (data int, err error) {
    ...
    if err != nil {
        err = errors.New("DECR err:" + err.Error())
        return
    }
    data = reply
    return
...
func DECRBY(key string, val int) (data int, err error) {
    ...
    if err != nil {
        err = errors.New("DECRBY err:" + err.Error())
        return
    }
    data = reply
    return
...
func GetStr(key string) (data string, err error) {
    ...
    if err != nil {
        err = errors.New("GET err:" + err.Error())
        return
    }
    data = reply
    return
...
func SetStr(key string, value string, expire int64) (err error) {
    ...
    if err != nil {
        err = errors.New("SET err:" + err.Error())
        return
    }
...
func HGetAllMap(key string) (data map[string]string, err error) {
    ...
    if err != nil {
        err = errors.New("HGetall map err:" + err.Error())
        return
    }
    data = reply
    return
...
func HGet(key string, field interface{}) (data string, err error) {
    ...
    if err != nil {
        err = errors.New("Hget err:" + err.Error())
        return
    }
